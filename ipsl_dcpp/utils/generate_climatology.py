...
np.save('climatology_subset_and_tos_surface_means.npy',np.stack(surface_month_means))
np.save('climatology_subset_and_tos_surface_stds.npy',np.stack(surface_month_stds))
